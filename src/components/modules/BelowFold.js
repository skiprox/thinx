    ...
    <article className="BelowFold">
      ...
      <div className="Container Container--thin flex justify-between items-center">
        <div className="BelowFold__item">
          ...
          <a href="#" className="BelowFold__link">Shop Hiphugger</a>
          <p className="BelowFold__description">heavy days</p>
        </div>
        <div className="BelowFold__item">
          <img className="BelowFold__image BelowFold__image--small" src="/images/bottom/thinx_productpage-03.jpg"></img>
          <a href="#" className="BelowFold__link">Shop Hiphugger</a>
          <p className="BelowFold__description">heavy days</p>
        </div>
      </div>
      ...
      <div className="Container Container--thin flex justify-between items-center">
        ...
        <div className="BelowFold__item">
          <img className="BelowFold__image BelowFold__image--small" src="/images/bottom/thinx_productpage-08.jpg"></img>
          <a href="#" className="BelowFold__link">Shop Hiphugger</a>
          <p className="BelowFold__description">heavy days</p>
        </div>
      </div>
